...
public class NumberStatistics {
    ...
    public int minDifferenceBetweenNeighbours() {
        ...
        for(int i = 1; i < numbers.size() - 1; i++) {
            int actDifference = ((numbers.get(i) - numbers.get(i + 1))>=0) ? numbers.get(i) - numbers.get(i + 1) : numbers.get(1) - numbers.get(0);
    ...
    public static void main(String[] args) {
        ...
        NumberStatistics a  =new NumberStatistics(Arrays.asList(1));
        a.minDifferenceBetweenNeighbours();
